...
const Reserve = () => {
  ...
  const handleClickSeeTerms = () => {
    setIsSeeTermsVisible(!isSeeTermsVisible);
  }
  return (
    <div>
      {isSeeTermsVisible && (
        <div className="overlay" onClick={handleClickSeeTerms}></div>
      )}
      <div className="mobile-reserve-cover">
        <div className="mobile-reserve">
          <div className="mobile-get-reserve">
            When do you want to be picked up?
          </div>
          <div className="mobile-reserve-details">
        ...
        <div className="reserve-ride-details">
          <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none">
            <title>Calendar</title>
            <path
              fill-rule="evenodd"
        ...
        <div className={`reserve-bottom-card ${isSeeTermsVisible ? "bottom-0" : "-bottom-full"}`}>
          ...
          <div className="terms-conditions">
            ...
            <div className="px-2 pb-5">
              ...
              your guest rider should meet the driver to begin the trip within
            ...
            <div className="px-2 pb-5">
              However, if your driver is expected to be significantly late,
              we’ll let you know in advance, and you'll have 10 minutes from
              that notice to cancel at no charge.
            </div>
            //////////////////////////////////
