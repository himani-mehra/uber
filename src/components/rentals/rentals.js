...
import "./rentals.css";
import rentalImage from "../../assests/rental.png";

const Rentals = () => {
  return (
    <div className="rentals">
      <img src={rentalImage} alt="Rental" className="rental-image" />
      <div className="get-rentals">Uber Rentals</div>
      <div className="rentals-details">
        <div className="rentals-input">
          <svg
            width="1em"
            height="1em"
            viewBox="0 0 24 24"
        ...
        <div className="rentals-input">
          ...
          <div className="text-grayish">Book for now or reserve for later</div>
        </div>
        <button className="search">Get started</button>
      </div>
    </div>
  );
};
